	  ...
	  <View style={styles.root}>
		  <View className={"w-full h-full pl-4 pr-4"}>
			  ...
			  <View className={"p-4 bg-white w-full h-[30%] rounded-2xl"} style={styles.shadowProp}>
				  <View className={"flex-row"}>
					  ...
					  <View className={"w-full ml-3"}>
						  <View className={"flex-row items-center mb-2"}>
							  <Text
								className={"text-2xl font-semibold mr-2"}>{dataVisitor.firstName + " " + dataVisitor.lastName}</Text>
							  <BackButton />
						  </View>
				  ...
				  <View className={"w-full h-full flex-row justify-between mt-4"}>
					  <View>
						  ...
						  <Text className={"text-gray-400 text-sm w-3/4"}>Note moyenne
							  sur {dataVisitor.numberOfVisits}</Text>
					  </View>
			  ...
			  <View className={"mt-1 w-full h-full"}>
				  ...
				  <Text className={"ml-3 mb-1 mt-2 text-lg font-medium text-gray-500 uppercase"}>Autres choix
					  possible</Text>
